...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <section className="relative py-8 sm:py-16 lg:py-24 px-4 sm:px-6 overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6 sm:mb-8 animate-fade-in">
              <Badge className="mb-4 sm:mb-6 bg-eco-primary/10 text-eco-primary border-eco-primary/20 text-xs sm:text-sm lg:text-base px-3 sm:px-4 py-1 sm:py-1.5">
              ...
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-4 sm:mb-6">
                ...
                <span className="text-lg sm:text-2xl md:text-3xl lg:text-4xl text-gray-700 block mt-2 sm:mt-3">
                  Dados Científicos, Conscientização Real
                </span>
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed mb-4 sm:mb-6 max-w-3xl mx-auto">
            ...
            <div className="mb-6 sm:mb-10 animate-fade-in" style={{ animationDelay: '0.5s' }}>
              <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-2xl border border-green-100 max-w-lg mx-auto">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 transition-all duration-500" 
            ...
            {/* CTAs Principais */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-12 animate-fade-in" style={{ animationDelay: '1s' }}>
              <Link to="/impactos" className="w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white px-6 sm:px-10 py-2.5 sm:py-3 text-sm sm:text-base font-semibold">
              ...
              <Link to="/calculator" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-2 border-eco-primary text-eco-primary hover:bg-eco-primary hover:text-white px-6 sm:px-10 py-2.5 sm:py-3 text-sm sm:text-base font-semibold">
      ...
      <section className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-eco-primary to-green-600 text-white p-5 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl shadow-2xl max-w-4xl mx-auto">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-5">
                A Mudança Começa com a Consciência
              </h3>
              <p className="text-sm sm:text-base lg:text-lg mb-5 sm:mb-6 opacity-90 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-5 sm:mb-6">
                <div>
                  ...
                  <div className="text-xs opacity-90">empresas comprometidas (2023)</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold">40-84%</div>
                  <div className="text-xs opacity-90">redução possível de emissões</div>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold">3.9%</div>
                  <div className="text-xs opacity-90">das emissões globais</div>
                </div>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <Link to="/calculator" className="w-full sm:w-auto">
                  <Button size="lg" variant="secondary" className="w-full sm:w-auto bg-white text-eco-primary hover:bg-gray-100 px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold">
                    Calcule Seu Impacto
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </Link>
                <Link to="/dados" className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-2 border-white text-white hover:bg-white/20 px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold">
